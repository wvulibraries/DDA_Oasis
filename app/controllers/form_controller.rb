class FormController < ApplicationController
  ...
  def submit
    redirect_to '/create', error: 'Missing ISBN' and return if form_params[:ISBN].blank?
    redirect_to '/create', error: 'Please Select a Site Location' and return if form_params[:Site].blank?
